...
public class TableDataHolder : Singleton<TableDataHolder> {
    public class TableData {
        ...
        public TableData(string name, string _class, float GPR, int storeys) {
            building_name = name;
    ...
    public void Start() {
        ...
        dataDict["AXA_tower"] = new TableData("AXA Tower", classes[0], 8.71f, 84);
        dataDict["V_On_shenton"] = new TableData("V On Shenton", classes[0], 12.8f, 1);
        dataDict["Capital_tower"] = new TableData("Capital Tower", classes[2], 13.41f, 83);
        dataDict["Robinson_77"] = new TableData("Robinson 77", classes[2], 11.41f, 61);
        dataDict["SBF_centre"] = new TableData("SBF Centre", classes[0], 12.31f, 33);
        dataDict["Asia_square"] = new TableData("Asia Square", classes[2], 13.9f, 74);
